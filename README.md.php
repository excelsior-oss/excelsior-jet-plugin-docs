...
Version 1.0.0 (??-Apr-2017)

First not beta release. It contains the following:

* The plugin documentation was reworked and moved to Wiki
* The plugin was tested against all platforms/editions that Excelsior JET 11.0 and 11.3 support 
* Minor bug fixes found by users and during the testing
* Windows version-information resource is not generated by default now. 
  If you would like to return to the previous behavior add 
  <?php param_pattern('addWindowsVersionInfo', 'true'); ?> to the plugin configuration
* Missed <?php param('stackAllocation'); ?> parameter added to control allocation of Java objects on the stack
